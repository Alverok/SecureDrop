...
// backend attachment validation exists
// frontend should roughly match it
...
export default function SubmitPage() {
  ...
  const handleFile = (
    ...
    if (
      ...
      setFileError(
        'File type not allowed. Accepted: PDF, JPG, PNG, GIF, TXT, ZIP',
      );
          ...
          <div className="field">
            ...
            >
              <input
                ...
                accept=".pdf,.jpg,.jpeg,.png,.gif,.txt,.zip"
              />
